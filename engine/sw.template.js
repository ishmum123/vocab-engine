...
// filling in __VE_BUILD__ (cksum of the built page before its marker line) and __VE_PAGE__
...
//   __VE_AUDIO__), capped at AUDIO_CAP clips with the oldest-stored evicted. activate
...
const AUDIO_CACHE = PREFIX + "audio:v" + "__VE_AUDIO__";
const AUDIO_CAP = 800;
